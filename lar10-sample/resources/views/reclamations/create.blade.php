...
<nav class="page-breadcrumb">
    ...
    <div class="row">
					<div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h1 class="card-title">Formulaire de reclamation</h1>
								<form>

									<!-- <div class="mb-3">
										<label for="exampleInputText1" class="form-label">Type de reclamation</label>
										<input type="text" name="typereclam" class="form-control" id="exampleInputText1">
									</div> -->
        
					
								<div class="mb-3">
									<label class="form-label">Je suis</label>
									<select name="jesuis" class="js-example-basic-single form-select" data-width="100%" id="jesuisSelect">
								...
								<div class="mb-3">
									...
									<select name="typereclam" class="js-example-basic-single form-select" data-width="100%">
									...
									<div class="mb-3">
										...
										<input type="text" name="nom" class="form-control" id="exampleInputNumber1">
									</div>

									<div class="mb-3">
										<label for="exampleInputNumber1" class="form-label">Prenom</label>
										<input type="text" name="prenom" class="form-control" id="exampleInputNumber1">
									</div>

									<div class="mb-3">
										<label for="exampleInputPassword3" class="form-label">CNE/MASSAR</label>
										<input type="text" name="cne" class="form-control" id="exampleInputPassword3" >
									</div>
                  ...
                  <div class="mb-3">
									...
									<select name="etablissement" class="js-example-basic-single form-select" data-width="100%">
