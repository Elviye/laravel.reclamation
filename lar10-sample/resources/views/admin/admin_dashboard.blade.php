...
<nav class="page-breadcrumb">
    ...
    <div class="row">
            ...
            <div class="card">
              <div class="card-body">
								<h6 class="card-title">Reclamations</h6>
										...
										<table class="table" >
                                            ...
                                            @foreach($reclamations as $reclamation)
                                                <tr>
                                                     ...
                                                     <td>
                                                          <form action="{{ route('admin.admin_dashboard', ['id' => $reclamation->id]) }}" method="POST">
                                                                @csrf
                                                     ...
                                                     <td>
                                                    @csrf
                                                    <button type="button" id="openModalButton" class="btn btn-primary">Repondre</button>
                                                     ...
                                                     <div class="modal-dialog">
                                                       <div class="modal-content">
                                                         ...
                                                         <div class="modal-body">
                                                           ...
                                                           <textarea id="emailMessage" class="form-control" rows="5"></textarea>
                                                         </div>
